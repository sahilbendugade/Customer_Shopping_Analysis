...
It is a Data Analysis project showcasing how behavior of customer towards there shopping, It is a complete analysis towards different aspects which gives end to end detailed information about the product. The project is done using Python, SQL, and Power Bi.

📊 Data Analytics Project
Overview

This project demonstrates an end-to-end data analytics workflow, starting from data loading and exploration to database querying and dashboard creation. The goal is to extract meaningful insights from raw data and present them through an interactive Power BI dashboard and a structured analytical report.
